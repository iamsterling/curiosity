...
export interface ChildAuthorityAgent {
...
export interface ChildAuthorityTool {
  readonly requestedCapabilities: readonly string[];
}

export interface ChildAuthorityCatalogPort {
  readonly agent: (agentId: string) => ChildAuthorityAgent | undefined;
  readonly tool: (toolName: string) => ChildAuthorityTool | undefined;
}
...
export const childRunAuthority = (input: {
  ...
  readonly catalog: ChildAuthorityCatalogPort;
