...
if (mode === "semantic") {
  ...
  await writeJsonExclusive(output, {
    schemaVersion: "custom-harness-q1-r2-identity-observation/v1",
    verdict: "PASS",
  ...
  await writeJsonExclusive(output, {
    schemaVersion: "custom-harness-q1-r2-invalidation/v1",
    verdict: "PASS",
  ...
  ].map((name) => readFileSync(join(r2Root, "probes", name), "utf8"));
  ...
  await writeJsonExclusive(output, {
    schemaVersion: "custom-harness-q1-r2-controls/v1",
    verdict: "PASS",
    ...
    copiedMaterial: {
      projectAuthoredProbeFiles: [
        "probes/effect-consumer-probe-r2.ts",
        "probes/effect-consumer-r2.test.ts",
      ],
