...
assert.equal(definitions,2,"the entrypoint must define one Promise compatibility setup and one Effect host plugin")
...
console.log(`Architecture verified: ${source.length} source files, ${manifest.assets.length} assets, Effect host entrypoint`)
