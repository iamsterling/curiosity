...
ADR 0041 accepts the unified retrieval and validated-memory evidence substrate
as design only; it does not authorize implementation, crawling, corpus
acquisition, or deployment. Canonical plugin
[ADR 0024](../plugin/opencode2/docs/decisions/0024-durable-ledger-v2-and-capture-authority.md)
accepts its Ledger durability follow-up as design only. Implementation and
production authority/persistence remain blocked on all of that ADR's gates; this
repository retains only a [moved provenance stub](docs/decisions/moved-durable-ledger-v2-and-capture-authority.md).
...
Search/retrieval documentation and the bounded M1–M7 runtime implementation
belong here. The accepted cross-boundary substrate design remains here as ADR
0041, while Ledger/Loop implementation and canonical Ledger durability design
belong to the plugin. Curiosity execution records, generic research, harness
