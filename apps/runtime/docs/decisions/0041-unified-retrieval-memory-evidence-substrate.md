...
see the [current-state record](../../../plugin/opencode2/docs/architecture/current-state.md)
and [ADR 0012](../../../plugin/opencode2/docs/decisions/0012-ledger-native-product.md).
