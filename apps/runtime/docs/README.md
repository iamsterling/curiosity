...
- **Accepted (isolated development benchmark only; production/live crawling remain NO-GO):** [ADR 0061: development owned-retrieval query mode](decisions/0061-development-owned-retrieval-query-mode.md)
