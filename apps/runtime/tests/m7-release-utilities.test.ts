...
test("generated clean-environment smoke uses the exact real host and bundled ripgrep twice without external attempts", () => {
  ...
  writeFileSync(entry, m7PluginAdapterSource({ delegate: new URL("../../opencode2-config/dist/index.js", import.meta.url).pathname, effect: new URL("../../opencode2-config/node_modules/effect/dist/index.js", import.meta.url).pathname }));
